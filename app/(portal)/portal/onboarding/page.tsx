    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 py-12 px-4 relative overflow-hidden">
      ...
      <div className="relative max-w-xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={tx} className="mb-8">
          ...
          <p className="text-sm text-zinc-500 dark:text-white/40">Let&apos;s set up your Codezilla profile. This takes less than a minute.</p>
        </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                {DOMAINS.map((d) => (
                  <option key={d} value={d} className="bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white">{d}</option>
                ))}
              </select>
            </div>
